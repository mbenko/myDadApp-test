    ...
    public partial class ChoresView : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                AS 
                with myChores_CTE (Id, Owner, Title, Description, createdAt, CompleteAt, Depth, Sort) as
                (
	                select Id, Owner, convert(nvarchar(255),Title), Description, createdAt, CompleteAt, 0 as Depth, Convert(nvarchar(255), Title) as Sort
	                from chore s
	                where Owner is null
	                UNION ALL
	                select e.Id, e.Owner, 
